...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm('service_tib11tw', 'template_ef6xrwa', form.current, {
                publicKey: 'WmI19e9xVtCjK4c8k',
            })
            .then(
                () => {
                    Swal.fire({
    ...
    return (
        <div id="Contact" className="mt-5">
            <h1 className="text-4xl font-bold text-black text-center">Contact Me</h1>
            <div className="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-[#2e0249] rounded-lg">
                ...
                <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                    <div>
                        ...
                        <p className="text-sm text-gray-300 mt-4 leading-relaxed">Have some big idea or brand to develop and need help? Then reach out we love to hear about your project  and provide help.</p>
                        ...
                        <ul className="flex mt-12 space-x-4">
                            <li className="bg-white h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                <a href="https://www.linkedin.com/in/devesh-biswas" target="_blank">
                                <FaLinkedin className="text-2xl" />
                                </a>
                            </li>
                            <li className="bg-white h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                <a href="https://github.com/deveshbis" target="_blank">
                                <FaGithub  className="text-2xl"/>
                                </a>
                            </li>
                            <li className="bg-white h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                                <a  href="https://www.facebook.com/pranta.theo/" target="_blank">
                    ...
                    <div className="bg-gray-100 p-6 rounded-lg">
                        ...
                        <form ref={form} onSubmit={sendEmail} className="mt-8 space-y-4">
                            ...
                            <input type="email" name="user_email" placeholder='Email'
                                className="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#a91079]" />
                            <textarea name="message" placeholder='Message' rows="6" className="w-full rounded-lg px-4 text-gray-800 text-sm pt-3 outline-[#a91079]" />
